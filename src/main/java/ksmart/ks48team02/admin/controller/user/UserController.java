...
public class UserController {
    ...
    @ResponseBody
    public List<UserManagement> getLoginLog(@RequestParam(name="memberId") String memberId, Model model){
        List<UserManagement> loginLogs = userManagementService.getLoginLogById(memberId);
